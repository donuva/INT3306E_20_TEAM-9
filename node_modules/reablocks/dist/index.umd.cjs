...
(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react"), require("react/jsx-runtime"), require("chroma-js"), require("ellipsize"), require("pluralize"), require("human-format"), require("classnames"), require("coverup"), require("date-fns"), require("framer-motion"), require("mousetrap"), require("rdk"), require("react-input-autosize"), require("react-highlight-words"), require("@reaviz/react-use-fuzzy"), require("react-fast-compare"), require("react-textarea-autosize"), require("name-initials"), require("string-to-color"), require("focus-trap-react"), require("create-global-state-hook")) : typeof define === "function" && define.amd ? define(["exports", "react", "react/jsx-runtime", "chroma-js", "ellipsize", "pluralize", "human-format", "classnames", "coverup", "date-fns", "framer-motion", "mousetrap", "rdk", "react-input-autosize", "react-highlight-words", "@reaviz/react-use-fuzzy", "react-fast-compare", "react-textarea-autosize", "name-initials", "string-to-color", "focus-trap-react", "create-global-state-hook"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.reablocks = {}, global2.React, global2.jsxRuntime, global2.chroma, global2.ellipsize, global2.pluralizeLib, global2.humanFormat, global2.classNames, global2.coverup, global2.dateFns, global2.framerMotion, global2.Mousetrap, global2.rdk, global2.AutosizeInput, global2.Highlighter, global2.reactUseFuzzy, global2.isEqual, global2.TextareaAutosize, global2.getInitials, global2.stc, global2.FocusTrap, global2.creteGlobalStateHook));
})(this, function(exports2, React, jsxRuntime, chroma, ellipsize, pluralizeLib, humanFormat, classNames, coverup, dateFns, framerMotion, Mousetrap, rdk, AutosizeInput, Highlighter, reactUseFuzzy, isEqual, TextareaAutosize, getInitials, stc, FocusTrap, creteGlobalStateHook) {
  "use strict";
  ...
  const ColorBlock = ({ name, color }) => /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      style: {
  ...
  const ColorBlocks = () => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        children: colors ? /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: Object.keys(colors).map((key) => /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            style: {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(
                "div",
                {
                  ...
                  children: typeof colors[key] === "string" ? /* @__PURE__ */ jsxRuntime.jsx(ColorBlock, { name: `--${key}`, color: colors[key] }) : /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: Object.keys(colors[key]).map((color) => /* @__PURE__ */ jsxRuntime.jsx(
                    ColorPaletteBlock,
                    {
                      name: `--${key}-${color}`,
  ...
  const TypographyLetterBlock = ({ fontFamily }) => /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      style: {
        fontFamily,
  ...
  const TypographySizeBlock = ({ sizes }) => /* @__PURE__ */ jsxRuntime.jsx("div", { children: Object.keys(sizes).map((size) => /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      style: {
        fontSize: sizes[size],
  ...
  const TypographyWeightBlock = ({ weights }) => /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      style: {
        padding: "var(--spacing-md)",
  ...
  const IconBlocks = ({ icons }) => /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      style: {
        display: "grid",
  ...
  function formatSize(size, emptyValue = "N/A") {
    let newSize = size;
  ...
  const DataSize = ({ value, emptyValue }) => /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: formatSize(value, emptyValue) });
  ...
  const Redact = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      "span",
      {
        ...
        role: "button",
        className: classNames(className, { [css$M.btn]: allowToggle }),
  ...
  const DateFormat = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      "time",
      {
        ...
        role: "button",
        className: classNames(className, { [css$L.btn]: allowToggle }),
        onClick: onToggle,
  ...
  const button$1 = "_button_koq2t_1";
  const disabled$7 = "_disabled_koq2t_9";
  const hasValue = "_hasValue_koq2t_12";
  const icon$2 = "_icon_koq2t_17";
  const descIcon = "_descIcon_koq2t_24";
  const css$K = {
    button: button$1,
    disabled: disabled$7,
    hasValue,
  ...
  const Sort = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        className: classNames(css$K.button, className, {
          [css$K.disabled]: disabled2,
          [css$K.hasValue]: direction !== void 0 && direction !== null
        }),
        role: "button",
        tabIndex: -1,
        ...
        children: [
          children,
          /* @__PURE__ */ jsxRuntime.jsxs(framerMotion.AnimatePresence, { initial: false, exitBeforeEnter: true, children: [
            direction === "asc" && /* @__PURE__ */ jsxRuntime.jsx(
              framerMotion.motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntime.jsx(
                  Icon,
                  {
                    className: classNames(css$K.icon, iconClassName, css$K.ascIcon)
                  }
                )
              },
              "asc"
            ...
            direction === "desc" && /* @__PURE__ */ jsxRuntime.jsx(
              framerMotion.motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntime.jsx(
                  Icon,
                  {
                    className: classNames(css$K.icon, iconClassName, css$K.descIcon)
                  }
                )
              },
              "desc"
  ...
  const container$c = "_container_tjtgz_1";
  const input$3 = "_input_tjtgz_8";
  ...
  const CommandPaletteInput = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: css$J.container, children: [
      icon2 && /* @__PURE__ */ jsxRuntime.jsx("span", { className: css$J.icon, children: icon2 }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "input",
        {
          className: css$J.input,
          ref: inputRef,
          type: "text",
          value,
          placeholder,
  ...
  const List = React.forwardRef(
    ({ className, children, ...rest }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        ref,
        role: "list",
        className: classNames(className, css$I.list),
        children
      }
    )
  );
  const listItem = "_listItem_r6l8m_1";
  const startAdornment$2 = "_startAdornment_r6l8m_10";
  const endAdornment$2 = "_endAdornment_r6l8m_14";
  ...
  const ListItem = React.forwardRef(
    ({
      ...
      "div",
      {
        ...
        className: classNames(className, css$H.listItem, {
          [css$H.disabled]: disabled2,
          [css$H.active]: active2,
          [css$H.clickable]: onClick && !disabled2,
          [css$H.disablePadding]: disablePadding2,
          [css$H.disableGutters]: disableGutters2,
          [css$H.dense]: dense2
        }),
        children: [
          start && /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$H.startAdornment, children: start }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$H.content, children }),
          end && /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$H.endAdornment, children: end })
        ]
      }
    )
  );
  const root$7 = "_root_1u76g_1";
  const disableMargins$7 = "_disableMargins_1u76g_8";
  const css$G = {
    root: root$7,
    disableMargins: disableMargins$7
  };
  const primary$2 = "_primary_1h9pf_1";
  const secondary$2 = "_secondary_1h9pf_5";
  const error$6 = "_error_1h9pf_9";
    ...
    ({
      ...
      "h1",
      {
        ...
        className: classNames(
          ...
          common[variant],
          css$G.root,
          { [css$G.disableMargins]: disableMargins2 },
          className
        ),
        ...rest,
        children
  ...
  const disableMargins$6 = "_disableMargins_9g7kd_8";
  const css$F = {
    root: root$6,
  ...
  const disableMargins$5 = "_disableMargins_1o2ul_8";
  const css$E = {
    root: root$5,
  ...
  const disableMargins$4 = "_disableMargins_1dv3y_8";
  const css$D = {
    root: root$4,
    ...
    ({
      ...
      "h5",
      {
        ...
        className: classNames(
          ...
          common[variant],
          css$D.root,
          { [css$D.disableMargins]: disableMargins2 },
          className
        ),
        ...rest,
        children
  ...
  const disableMargins$3 = "_disableMargins_1dwi9_7";
  const css$C = {
    root: root$3,
    ...
    ({ color, variant, disableMargins: disableMargins2, children, className, ...rest }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
      "h6",
      {
        ...
        className: classNames(
          ...
          common[variant],
          css$C.root,
          { [css$C.disableMargins]: disableMargins2 },
          className
        ),
        ...rest,
        children
  ...
  const header$4 = "_header_1ffms_1";
  const css$A = {
    header: header$4
  };
  const ListHeader = ({
    ...
    children,
    ...rest
  }) => /* @__PURE__ */ jsxRuntime.jsx(Sub, { ...rest, className: classNames(className, css$A.header), children });
  const card$1 = "_card_o9yl3_1";
  const disablePadding$5 = "_disablePadding_o9yl3_11";
  const header$3 = "_header_o9yl3_15";
  ...
  const Card = React.forwardRef(
    ({
      ...
      "section",
      {
        ...rest,
        ref,
        className: classNames(className, css$z.card, {
          [css$z.disablePadding]: disablePadding2
        }),
        children: [
          header2 && /* @__PURE__ */ jsxRuntime.jsx("header", { className: classNames(css$z.header, headerClassName), children: header2 && typeof header2 === "string" ? /* @__PURE__ */ jsxRuntime.jsx("h3", { className: css$z.headerText, children: header2 }) : header2 }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: classNames(css$z.content, contentClassName), children })
        ]
      }
    )
  );
  ...
  const CommandPalette = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(Card, { className: css$y.card, disablePadding: true, ref: elementRef, children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        CommandPaletteInput,
        {
          value: filterText,
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(MotionGroup, { children: [
        hasChildren && /* @__PURE__ */ jsxRuntime.jsx(Card, { className: css$y.innerCard, disablePadding: true, children: /* @__PURE__ */ jsxRuntime.jsx(List, { children: flattenedTree }) }),
  ...
  const startAdornment$1 = "_startAdornment_df3yr_15";
  const content$4 = "_content_df3yr_21";
  const endAdornment$1 = "_endAdornment_df3yr_26";
  const small$8 = "_small_df3yr_33";
  const medium$8 = "_medium_df3yr_43";
  const large$8 = "_large_df3yr_53";
  const filled$1 = "_filled_df3yr_63";
  const primary$1 = "_primary_df3yr_72";
  const secondary$1 = "_secondary_df3yr_77";
  const error$5 = "_error_df3yr_82";
  ...
  const disableMargins$2 = "_disableMargins_df3yr_259";
  const css$x = {
    chip: chip$1,
  ...
  const Chip = React.forwardRef(
    ({
      ...
      "div",
      {
        ...
        onClick,
        className: classNames(css$x.chip, className, {
          [css$x[color]]: true,
          [css$x[variant]]: true,
          [css$x[size]]: true,
          [css$x.selected]: !!selected2,
          [css$x.disabled]: disabled2,
          [css$x.selectable]: onClick && !disabled2,
          [css$x.disableMargins]: disableMargins2
        }),
        children: [
          start && /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$x.startAdornment, children: start }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$x.content, children }),
          end && /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$x.endAdornment, children: end })
        ]
      }
    )
  );
  ...
  const btn$1 = "_btn_w1d54_1";
  const small$7 = "_small_w1d54_15";
  const medium$7 = "_medium_w1d54_20";
  const large$7 = "_large_w1d54_25";
  const filled = "_filled_w1d54_30";
  const primary = "_primary_w1d54_43";
  const secondary = "_secondary_w1d54_53";
  const error$4 = "_error_w1d54_63";
  const success$1 = "_success_w1d54_73";
  const warning$1 = "_warning_w1d54_83";
  const outline = "_outline_w1d54_94";
  const text = "_text_w1d54_158";
  const fullWidth$2 = "_fullWidth_w1d54_211";
  const disableMargins$1 = "_disableMargins_w1d54_216";
  const disablePadding$4 = "_disablePadding_w1d54_220";
  const css$w = {
    btn: btn$1,
    small: small$7,
    medium: medium$7,
  ...
  const Button = React.forwardRef(
    ({
      ...
      framerMotion.motion.button,
      {
        ...
        className: classNames(css$w.btn, className, {
          [css$w.fullWidth]: fullWidth2,
          [css$w.disableMargins]: disableMargins2,
          [css$w.disablePadding]: disablePadding2,
          [css$w[color]]: true,
          [css$w[size]]: true,
          [css$w[variant]]: true
        }),
      ...
      Chip,
      {
        ...
        disabled: disabled2,
          ...
          Button,
          {
            ...
            variant: "text",
            size,
            className: classNames(css$v.deleteButton, { [css$v[size]]: true }),
            onClick: (event) => {
              if (!disabled2) {
                event.stopPropagation();
  ...
  const container$b = "_container_a0oed_10";
  const css$u = {
    chip,
  ...
  const Kbd = ({ className, keycode, ...rest }) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("span", { className: css$u.container, children: split == null ? void 0 : split.map((key, index) => /* @__PURE__ */ jsxRuntime.jsx(Chip, { ...rest, className: classNames(css$u.chip, className), children: /* @__PURE__ */ jsxRuntime.jsx("kbd", { children: key }) }, index)) });
  };
  const item = "_item_1yrcu_1";
  const clickable$2 = "_clickable_1yrcu_3";
  const active$2 = "_active_1yrcu_8";
  const css$t = {
    item,
  ...
  const CommandPaletteItem = React.forwardRef(({ children, active: active2, className, end, hotkey, onClick, ...rest }, ref) => /* @__PURE__ */ jsxRuntime.jsx(MotionItem, { layout: true, children: /* @__PURE__ */ jsxRuntime.jsx(
    ListItem,
    {
      ...rest,
      ref,
      className: classNames(className, css$t.item, {
        [css$t.active]: active2,
        [css$t.clickable]: onClick
      }),
  ...
  const CommandPaletteSection = React.forwardRef(({ children, className, title, index, ...rest }, ref) => /* @__PURE__ */ jsxRuntime.jsx(MotionItem, { layout: true, children: /* @__PURE__ */ jsxRuntime.jsxs(
    List,
    {
      ref,
      ...rest,
      className: classNames(css$s.section, className, {
        [css$s.first]: index === 0
      }),
      children: [
  ...
  const SvgArrowPrevious = (props) => /* @__PURE__ */ React__namespace.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 32", width: "32px", height: "32px", ...props }, /* @__PURE__ */ React__namespace.createElement("path", { d: "M 19.03125 4.28125 L 8.03125 15.28125 L 7.34375 16 L 8.03125 16.71875 L 19.03125 27.71875 L 20.46875 26.28125 L 10.1875 16 L 20.46875 5.71875 Z" }));
  const SvgArrowNext = (props) => /* @__PURE__ */ React__namespace.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 32", width: "32px", height: "32px", ...props }, /* @__PURE__ */ React__namespace.createElement("path", { d: "M 12.96875 4.28125 L 11.53125 5.71875 L 21.8125 16 L 11.53125 26.28125 L 12.96875 27.71875 L 23.96875 16.71875 L 24.65625 16 L 23.96875 15.28125 Z" }));
  const SvgArrowStart = (props) => /* @__PURE__ */ React__namespace.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 32", width: "32px", height: "32px", ...props }, /* @__PURE__ */ React__namespace.createElement("path", { d: "M 9 4 L 9 28 L 11 28 L 11 16.414062 L 22.585938 28 L 24 26.585938 L 13.414062 16 L 24 5.4140625 L 22.585938 4 L 11 15.585938 L 11 4 L 9 4 z" }));
  const SvgArrowEnd = (props) => /* @__PURE__ */ React__namespace.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 32", width: "32px", height: "32px", ...props }, /* @__PURE__ */ React__namespace.createElement("path", { d: "M 9.4140625 4 L 8 5.4140625 L 18.585938 16 L 8 26.585938 L 9.4140625 28 L 21 16.414062 L 21 28 L 23 28 L 23 4 L 21 4 L 21 15.585938 L 9.4140625 4 z" }));
  const pager = "_pager_6ofa5_1";
  const page = "_page_6ofa5_1";
  const active$1 = "_active_6ofa5_14";
  const css$r = {
    pager,
    page,
    active: active$1
  ...
  const Pager = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: classNames(css$r.pager, className), children: [
      ...
      [...Array(total)].map((_, i) => /* @__PURE__ */ jsxRuntime.jsx(React.Fragment, { children: i >= startPage && i <= endPage && /* @__PURE__ */ jsxRuntime.jsx(
        Button,
        {
          variant: "text",
          size: "small",
          disabled: page2 === i,
          title: `Page ${i + 1}`,
          className: classNames(css$r.page, {
            [css$r.active]: page2 === i
          }),
  ...
  const container$a = "_container_10r86_1";
  const small$5 = "_small_10r86_12";
  const medium$5 = "_medium_10r86_16";
  const large$5 = "_large_10r86_20";
  const error$3 = "_error_10r86_30";
  const fullWidth$1 = "_fullWidth_10r86_34";
  const input$2 = "_input_10r86_37";
  const startAdornment = "_startAdornment_10r86_42";
  const endAdornment = "_endAdornment_10r86_43";
  const css$q = {
  ...
  const Input = React.forwardRef(
    ({
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          className: classNames(css$q.container, containerClassname, {
            [css$q.fullWidth]: fullWidth2,
            [css$q.error]: error2,
            [css$q[size]]: size
          }),
          ref: containerRef,
          children: [
            start && /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$q.startAdornment, children: start }),
            /* @__PURE__ */ jsxRuntime.jsx(
              "input",
              {
                ...rest,
                ...
                value,
                disabled: disabled2,
                className: classNames(className, css$q.input),
                onFocus: (event) => {
                  if (selectOnFocus) {
                    event.target.select();
                  }
            ...
            end && /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$q.endAdornment, children: end })
          ]
        }
      );
    }
  ...
  const container$9 = "_container_17lfr_1";
  const small$4 = "_small_17lfr_10";
  const medium$4 = "_medium_17lfr_15";
  const large$4 = "_large_17lfr_20";
  const css$p = {
  ...
  const DotsLoader = ({ className, size, speed }) => /* @__PURE__ */ jsxRuntime.jsx(
    framerMotion.motion.div,
    {
      className: classNames(className, css$p.container, {
        [css$p.small]: size === "small",
        [css$p.medium]: size === "medium",
        [css$p.large]: size === "large"
      }),
  ...
  const disabled$5 = "_disabled_sipe1_17";
  const css$o = {
    tag,
    disabled: disabled$5
  };
  const SelectInputChip = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "span",
      {
        className: classNames(css$o.tag, className, "select-input-chip"),
        title: origLabel,
        tabIndex: -1,
  ...
  const container$8 = "_container_13579_1";
  const open = "_open_13579_12";
  const disabled$4 = "_disabled_13579_17";
  const expand = "_expand_13579_22";
  const input$1 = "_input_13579_23";
  const unfilterable = "_unfilterable_13579_28";
  const error$2 = "_error_13579_34";
  const inputContainer = "_inputContainer_13579_38";
  const single = "_single_13579_71";
  const prefix = "_prefix_13579_72";
  const multiple = "_multiple_13579_95";
  const suffix = "_suffix_13579_109";
  const loader = "_loader_13579_119";
  const btn = "_btn_13579_125";
  const refresh = "_refresh_13579_146";
  const close$1 = "_close_13579_147";
  const css$n = {
  ...
  const SelectInput = ({
    ...
    const renderPrefix = React.useCallback(() => {
      if (multiple2) {
        ...
        if (multipleOptions == null ? void 0 : multipleOptions.length) {
          return /* @__PURE__ */ jsxRuntime.jsx("div", { className: classNames(css$n.prefix, "select-input-value"), children: multipleOptions.map((option2) => /* @__PURE__ */ jsxRuntime.jsx(
            rdk.CloneElement,
            {
              element: chip2,
              option: option2,
        ...
        if ((singleOption == null ? void 0 : singleOption.inputLabel) && !inputText) {
          return /* @__PURE__ */ jsxRuntime.jsx("div", { className: classNames(css$n.prefix, "select-input-value"), children: singleOption == null ? void 0 : singleOption.inputLabel });
        }
      }
      return null;
    }, [
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      ...
      {
        ref: containerRef,
        className: classNames(css$n.container, "select-input", className, {
          [css$n.disabled]: disabled2,
          [css$n.unfilterable]: !filterable,
          [css$n.error]: error2,
          [css$n.single]: !multiple2,
          [css$n.multiple]: multiple2,
          [css$n.open]: menuOpen
        }),
        onClick: onContainerClick,
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: css$n.inputContainer, onClick: onInputFocus, children: [
            renderPrefix(),
            /* @__PURE__ */ jsxRuntime.jsx(
              AutosizeInput,
              {
                ...
                inputClassName: classNames(css$n.input, "select-input-input"),
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: css$n.suffix, children: [
            refreshable && !loading && /* @__PURE__ */ jsxRuntime.jsx(
              "button",
              {
                ...
                disabled: disabled2,
                className: classNames(css$n.refresh, css$n.btn, "select-input-refresh"),
                onClick: onRefresh,
                children: refreshIcon
              }
            ),
            loading && /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$n.loader, children: loadingIcon }),
            showClear && /* @__PURE__ */ jsxRuntime.jsx(
              "button",
              {
                ...
                disabled: disabled2,
                className: classNames(css$n.close, css$n.btn, "select-input-clear"),
            ...
            !menuDisabled && /* @__PURE__ */ jsxRuntime.jsx(
              "button",
              {
                ...
                disabled: disabled2,
                className: classNames(css$n.expand, css$n.btn, "select-input-toggle"),
  ...
  const SelectMenu = ({
    ...
    const renderListItems = React.useCallback(
      (items, group2) => items.map((o, i) => /* @__PURE__ */ jsxRuntime.jsx(
        ListItem,
        {
          className: classNames(css$m.option, "select-menu-item", {
            [css$m.selected]: checkOptionSelected(o),
            [css$m.active]: index === i + ((group2 == null ? void 0 : group2.offset) || 0),
            [css$m.diabled]: disabled2 || o.disabled
          }),
          onClick: (event) => {
            event.preventDefault();
            event.stopPropagation();
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        style,
        className: classNames(css$m.menu, className, "select-menu"),
        initial: {
          opacity: 0,
          y: -20,
          pointerEvents: "none"
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(List, { children: [
          ...
          groups.hasGroups ? groups.groups.map((g) => /* @__PURE__ */ jsxRuntime.jsx(React.Fragment, { children: g.name === "undefined" ? renderListItems(g.items, g) : /* @__PURE__ */ jsxRuntime.jsxs(
            ListItem,
            {
              className: classNames(css$m.groupItem, "select-menu-group"),
              children: [
  ...
  const root$2 = "_root_1nf4s_1";
  const input = "_input_1nf4s_22";
  const error$1 = "_error_1nf4s_49";
  const fullWidth = "_fullWidth_1nf4s_53";
  const small$3 = "_small_1nf4s_61";
  const medium$3 = "_medium_1nf4s_65";
  const large$3 = "_large_1nf4s_69";
  const css$l = {
    root: root$2,
    input,
    error: error$1,
  ...
  const Textarea = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        className: classNames(css$l.root, {
          [css$l.fullWidth]: fullWidth2,
          [css$l.error]: error2,
          [css$l[size]]: size
        }),
        children: /* @__PURE__ */ jsxRuntime.jsx(
          ...
          {
            ref: inputRef,
            className: classNames(css$l.input, className),
            ...rest
          }
        )
      }
  ...
  const disabled$3 = "_disabled_9855z_16";
  const small$2 = "_small_9855z_21";
  const handle$1 = "_handle_9855z_26";
  const medium$2 = "_medium_9855z_32";
  const large$2 = "_large_9855z_43";
  const checked$1 = "_checked_9855z_59";
  const css$k = {
    "switch": "_switch_9855z_1",
    disabled: disabled$3,
    small: small$2,
    handle: handle$1,
    medium: medium$2,
  ...
  const Toggle = React.forwardRef(
    ({ checked: checked2, disabled: disabled2, onChange, onBlur, className, size, ...rest }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        ref,
        tabIndex: 0,
        className: classNames(css$k.switch, className, {
          [css$k.disabled]: disabled2,
          [css$k.checked]: checked2,
          [css$k[size]]: true
        }),
        onClick: () => {
  ...
  const label$3 = "_label_1m42y_6";
  const clickable$1 = "_clickable_1m42y_11";
  const check = "_check_1m42y_17";
  const checkbox = "_checkbox_1m42y_21";
  const small$1 = "_small_1m42y_27";
  const medium$1 = "_medium_1m42y_32";
  const large$1 = "_large_1m42y_37";
  const disabled$2 = "_disabled_1m42y_46";
  const css$j = {
  ...
  const Checkbox = React.forwardRef(
    ({
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: classNames(css$j.container, containerClassName), children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          framerMotion.motion.div,
          {
            ...rest,
            ...
            className: classNames(css$j.checkbox, className, {
              [css$j.disabled]: disabled2,
              [css$j.small]: size === "small",
              [css$j.medium]: size === "medium",
              [css$j.large]: size === "large"
            }),
            onClick: (e) => {
              if (!disabled2 && onChange) {
                e.stopPropagation();
        ...
        label2 && /* @__PURE__ */ jsxRuntime.jsx(
          "span",
          {
            className: classNames(css$j.label, labelClassName, {
              [css$j.clickable]: !disabled2 && onChange
            }),
            onClick: () => {
              if (!disabled2 && onChange) {
  ...
  const container$6 = "_container_1ngjs_1";
  const label$2 = "_label_1ngjs_6";
  const clickable = "_clickable_1ngjs_12";
  const radio = "_radio_1ngjs_18";
  const indicator = "_indicator_1ngjs_32";
  const checked = "_checked_1ngjs_37";
  const small = "_small_1ngjs_41";
  const medium = "_medium_1ngjs_51";
  const large = "_large_1ngjs_61";
  const disabled$1 = "_disabled_1ngjs_71";
  const css$i = {
  ...
  const Radio = React.forwardRef(
    ({ checked: checked2, label: label2, disabled: disabled2, onChange, onBlur, className, size, ...rest }, ref) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: classNames(css$i.container, className), children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          ...rest,
  ...
  const RangeDouble = ({
    ...
    const initalMaxValue = Math.min(
      maxValue < initialMinValue + MIN_VALUE_BETWEEN ? initialMinValue + MIN_VALUE_BETWEEN : maxValue,
      max
    );
  ...
  const RangeSingle = ({
    ...
    React.useEffect(() => {
      ...
      setRangeLeft(range2.current.offsetLeft);
  ...
  const container$5 = "_container_tbkyo_1";
  const css$g = {
  ...
  const Collapse = ({
    ...
    {
      ...rest,
      className: classNames(className, css$g.section),
      key: "content",
      initial: "collapsed",
      animate: "open",
      exit: "collapsed",
  ...
  const disableMargins = "_disableMargins_6jom2_19";
  const css$f = {
    divider,
  ...
  const Divider = ({
    ...
    {
      ...rest,
      className: classNames(css$f.divider, className, {
        [css$f.disableMargins]: disableMargins2,
        [css$f.vertical]: orientation === "vertical",
        [css$f.horizontal]: orientation === "horizontal"
      })
    }
  );
  ...
  const container$4 = "_container_f4qjt_1";
  const disableMargin = "_disableMargin_f4qjt_4";
  const label$1 = "_label_f4qjt_8";
  const content$3 = "_content_f4qjt_15";
  const horizontal = "_horizontal_f4qjt_19";
  const centerAlign = "_centerAlign_f4qjt_29";
  const endAlign$1 = "_endAlign_f4qjt_33";
  const startAlign$1 = "_startAlign_f4qjt_38";
  const vertical = "_vertical_f4qjt_47";
  const disablePadding$3 = "_disablePadding_f4qjt_51";
  const css$e = {
  ...
  const Block = ({
    ...
    {
      ...rest,
      className: classNames(css$e.container, className, {
        [css$e.disableMargin]: disableMargin2,
        [css$e.horizontal]: direction === "horizontal",
        [css$e.vertical]: direction === "vertical",
        [css$e.endAlign]: alignment === "end",
        [css$e.centerAlign]: alignment === "center"
      }),
      children: [
        label2 && /* @__PURE__ */ jsxRuntime.jsxs(
          "label",
          {
            className: classNames(css$e.label, labelClassName),
  ...
  const container$3 = "_container_17b57_1";
  const inline = "_inline_17b57_6";
  const dense = "_dense_17b57_10";
  const column = "_column_17b57_14";
  const row = "_row_17b57_18";
  const startAlign = "_startAlign_17b57_22";
  const endAlign = "_endAlign_17b57_26";
  const endJustify = "_endJustify_17b57_30";
  const centerJustify = "_centerJustify_17b57_34";
  const spaceBetweenJustify = "_spaceBetweenJustify_17b57_38";
  const css$d = {
  ...
  const Stack = React.forwardRef(
    ({
      ...
      "div",
      {
        className: classNames(css$d.container, className, {
          [css$d.dense]: dense2,
          [css$d.inline]: inline2,
          [css$d[direction]]: direction,
          [css$d[`${alignItems}Align`]]: alignItems,
          [css$d[`${justifyContent}Justify`]]: justifyContent
        }),
        ref,
        ...otherProps,
        children
  ...
  const container$2 = "_container_188ba_1";
  const tree = "_tree_188ba_8";
  const css$c = {
    container: container$2,
    tree
  };
  const Tree = ({ children, className, ...rest }) => /* @__PURE__ */ jsxRuntime.jsx("div", { className: classNames(css$c.tree, className), ...rest, children: /* @__PURE__ */ jsxRuntime.jsx("ul", { className: css$c.container, children }) });
  const Arrow = (props) => /* @__PURE__ */ jsxRuntime.jsx(
    "svg",
    {
      ...props,
      xmlns: "http://www.w3.org/2000/svg",
  ...
  const label = "_label_1solv_11";
  const disabled = "_disabled_1solv_16";
  ...
  const TreeNode = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "li",
      {
        className: classNames(className, css$b.node, {
          [css$b.leaf]: !hasChildren,
          [css$b.disabled]: disabled2
        }),
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: css$b.nodeBlock, children: [
            hasChildren && /* @__PURE__ */ jsxRuntime.jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntime.jsx(
                  Arrow,
                  {
                    className: classNames(css$b.icon, { [css$b.collapsed]: !expanded })
                  }
                )
              }
            ),
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: css$b.label, children: label2 })
          ] }),
          hasChildren && /* @__PURE__ */ jsxRuntime.jsx(Collapse, { expanded, children: () => /* @__PURE__ */ jsxRuntime.jsx("ul", { className: css$b.subtree, children }) })
        ]
      }
    );
  };
  ...
  const Avatar = React.forwardRef(
    ({ name, src, color, size, rounded: rounded2, className, ...rest }, ref) => {
      const fontSize = size * 0.4;
      return /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          ...rest,
          className: classNames(css$9.avatar, className, {
            [css$9.rounded]: rounded2
          }),
          style: {
            width: `${size}px`,
            height: `${size}px`,
          ...
          ref,
          children: !src && name && /* @__PURE__ */ jsxRuntime.jsx("span", { children: getInitials(name) })
        }
      );
    }
  );
  ...
  const AvatarGroup = React.forwardRef(
    ({ children, className, size, ...rest }, ref) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { ...rest, ref, className: classNames(className, css$8.group), children: [
        data.map((child, index) => /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$8.avatar, children: child }, index)),
        hasMore && /* @__PURE__ */ jsxRuntime.jsxs("span", { className: css$8.overflow, children: [
          "+",
          remaining,
          " more"
        ] })
                ...
                children: /* @__PURE__ */ jsxRuntime.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntime.jsx("section", { id: `${id}-content`, className: css$5.content, children: typeof children === "function" ? children() : children }),
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx("div", { id, tabIndex: -1, children: /* @__PURE__ */ jsxRuntime.jsxs(
              framerMotion.motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$4.content, children: typeof children === "function" ? children() : children })
                ]
              }
            ) })
          }
