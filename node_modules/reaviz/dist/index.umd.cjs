...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react/jsx-runtime"), require("react"), require("rdk"), require("ellipsize"), require("d3-array"), require("d3-scale"), require("d3-shape"), require("human-format"), require("transformation-matrix"), require("classnames"), require("memoize-bind"), require("react-cool-dimensions"), require("big-integer"), require("chroma-js"), require("reablocks"), require("memoize-one"), require("react-fast-compare"), require("framer-motion"), require("d3-interpolate"), require("safe-identifier"), require("d3-geo"), require("d3-sankey"), require("@upsetjs/venn.js"), require("invert-color"), require("d3-hierarchy")) : typeof define === "function" && define.amd ? define(["exports", "react/jsx-runtime", "react", "rdk", "ellipsize", "d3-array", "d3-scale", "d3-shape", "human-format", "transformation-matrix", "classnames", "memoize-bind", "react-cool-dimensions", "big-integer", "chroma-js", "reablocks", "memoize-one", "react-fast-compare", "framer-motion", "d3-interpolate", "safe-identifier", "d3-geo", "d3-sankey", "@upsetjs/venn.js", "invert-color", "d3-hierarchy"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.reaviz = {}, global.jsxRuntime, global.react, global.rdk, global.ellipsize, global.d3Array, global.d3Scale, global.d3Shape, global.humanFormat, global.transformationMatrix, global.classNames, global.bind, global.useDimensions, global.bigInt, global.chroma, global.reablocks, global.memoize, global.isEqual, global.framerMotion, global.d3Interpolate, global.safeIdentifier, global.d3Geo, global.d3Sankey, global.venn_js, global.invert, global.d3Hierarchy));
})(this, function(exports2, jsxRuntime, react, rdk, ellipsize, d3Array, d3Scale, d3Shape, humanFormat, transformationMatrix, classNames, bind, useDimensions, bigInt, chroma, reablocks, memoize, isEqual, framerMotion, d3Interpolate, safeIdentifier, d3Geo, d3Sankey, venn_js, invert, d3Hierarchy) {
  "use strict";
  class LinearAxisTickLabel extends react.Component {
    ...
    getTickLineSpacing() {
      const { line: line2 } = this.props;
      if (!line2) {
        return [0, 0];
      }
      const size = line2.props.size;
      const position = line2.props.position;
      if (position === "start") {
        return [size * -1, 0];
  ...
  class LinearAxisTickSeries extends react.Component {
     ...
     */
    getLabelFormat() {
      const { label: label2, scale } = this.props;
     ...
     */
    getTicks() {
      const { scale, tickSize, tickValues, interval, axis, label: label2 } = this.props;
      const dimension = this.getDimension();
    ...
    render() {
      const { label: label2, line: line2, height, width, orientation } = this.props;
  ...
  LinearAxisTickSeries.defaultProps = {
    line: /* @__PURE__ */ jsxRuntime.jsx(LinearAxisTickLine, {}),
    label: /* @__PURE__ */ jsxRuntime.jsx(LinearAxisTickLabel, {}),
    tickSize: 30
  };
  ...
  class LinearAxis extends react.Component {
    ...
    render() {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("g", { transform: `translate(${translateX}, ${translateY})`, ref: this.ref, children: [
  ...
  LinearAxis.defaultProps = {
    ...
    tickSeries: /* @__PURE__ */ jsxRuntime.jsx(LinearAxisTickSeries, {}),
    scaled: false,
    roundDomains: false,
  ...
  const RadialAxisTickLabel = ({
    ...
    const { transform, textAnchor } = react.useMemo(() => {
      ...
      let transform2;
      if (autoRotate) {
        const l = point2 >= Math.PI;
        const r = point2 < 2 * Math.PI;
  ...
  const RadialAxisTickSeries = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(react.Fragment, { children: ticks.map((data, i) => /* @__PURE__ */ jsxRuntime.jsx(
      rdk.CloneElement,
      {
        element: tick,
        index: i,
  ...
  class BrushSlice extends react.PureComponent {
    ...
    onMoveStart() {
      const { start: start2, end: end2, width } = this.props;
    ...
    onMove({ x }) {
      ...
      let { start: start2, end: end2 } = this.props;
      start2 = start2 + x;
      end2 = end2 + x;
      if (start2 >= 0 && end2 <= width) {
        onBrushChange({
          start: start2,
          end: end2
        });
    ...
    onHandleDrag(direction, deltaX) {
      ...
      let { start: start2, end: end2 } = this.props;
      start2 = direction === "start" ? start2 + deltaX : start2;
      end2 = direction !== "start" ? end2 + deltaX : end2;
      onBrushChange({
        start: start2,
        end: end2
      });
    ...
    render() {
      const { height, start: start2, end: end2, width } = this.props;
      const { isDragging } = this.state;
  ...
  class Brush extends react.PureComponent {
    ...
    componentDidUpdate(prevProps) {
      ...
      if (!this.state.isSlicing && !this.state.isPanning) {
        const { start: start2, end: end2 } = this.props;
        const startUpdated = start2 !== prevProps.start && start2 !== this.state.start;
        const endUpdated = end2 !== prevProps.end && end2 !== this.state.end;
        if (startUpdated || endUpdated) {
          this.setState({
            ...this.ensurePositionInBounds(start2, end2)
          });
        }
      }
    }
    getStartEnd(event, state = this.state) {
      ...
      if (x < state.initial) {
        ...
        start2 = state.initial;
        end2 = x;
      }
      return this.ensurePositionInBounds(start2, end2, state);
    }
    ...
    onMove(event) {
      ...
      if (!disabled) {
        this.setState((prev) => {
          const { onBrushChange } = this.props;
          const { start: start2, end: end2 } = this.getStartEnd(event.nativeEvent, prev);
          if (onBrushChange) {
            onBrushChange({
              start: start2,
              end: end2
    ...
    render() {
      ...
      const { isSlicing, start: start2, end: end2 } = this.state;
      return /* @__PURE__ */ jsxRuntime.jsx(
        Move,
        {
          cursor: "crosshair",
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(
            "g",
            {
              ...
              children: [
                children,
                !disabled && /* @__PURE__ */ jsxRuntime.jsxs(react.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntime.jsx(
                    "rect",
                    {
      ...
      if (onBrushChange) {
        ...
        if (event.start !== void 0 && event.end !== void 0 && (event.start !== 0 || event.end !== width)) {
          if (scale.invert) {
            ...
            domain = [scale.domain()[start2], scale.domain()[end2]];
          }
        }
        onBrushChange({
          domain
  ...
  class SequentialLegend extends react.PureComponent {
    render() {
      ...
      const [end2, start2] = d3Array.extent(
        uniqueBy(
          data,
          (d) => d.data,
          (d) => d.data
  ...
  class TooltipArea extends react.Component {
    ...
    render() {
      const { isRadial, children, tooltip: tooltip2, disabled, color } = this.props;
      const { visible, placement, value: value2 } = this.state;
      return /* @__PURE__ */ jsxRuntime.jsxs(react.Fragment, { children: [
        disabled && children,
        !disabled && /* @__PURE__ */ jsxRuntime.jsxs("g", { onMouseLeave: bind(this.onMouseLeave, this), children: [
  ...
  class ZoomPan extends react.Component {
    ...
    static getDerivedStateFromProps(props, state) {
      const matrix = transformationMatrix.transform(
  ...
  const BarSeries = ({
    ...
    const onMouseMove = react.useCallback((event) => {
      var _a;
      (_a = ref.current) == null ? void 0 : _a.onMouseMove(event);
    }, []);
    const onValueEnter = react.useCallback((event) => {
      setActiveValues(event.value);
    }, []);
  ...
  const PieArcSeries = ({
    ...
    const { outerRadius, innerRadius, labelWidth } = calculateRadius(height, width, label2, arcWidth, doughnut);
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(react.Fragment, { children: data.map((arcData, index) => /* @__PURE__ */ jsxRuntime.jsxs(react.Fragment, { children: [
  ...
  const PieChart = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ChartContainer,
      {
        ...
        children: ({ chartWidth, chartHeight }) => /* @__PURE__ */ jsxRuntime.jsx(
          rdk.CloneElement,
          {
            element: series,
            data: getData,
  ...
  const RadialAreaChart = ({
    ...
    const getXScale2 = react.useCallback(
      ...
      [axis == null ? void 0 : axis.props.type, series.props.type]
    );
    const getScales = react.useCallback(
  ...
  const MotionBar = ({ custom, transition, arc, ...rest }) => {
    ...
    react.useEffect(() => {
      ...
      const unsub = spring.onChange(
        (v) => d.set(arc({ ...custom.enter, y: interpolator(v) }))
      );
    ...
    const getArc = react.useCallback(
      (data2) => {
        ...
        if (curved) {
          ...
          const startAngle = xScale(data2.x) - Math.PI * 0.5;
          const endAngle = startAngle + xScale.bandwidth();
  ...
  const RadialBarSeries = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      rdk.CloneElement,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx("g", { clipPath: `url(#${id}-path)`, children: data.map(renderBar) })
      }
    );
  };
  ...
  const RadialGauge = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ChartContainer,
      {
        ...
        className,
        containerClassName,
        children: (props) => react.cloneElement(series, {
          scale,
          data,
          startAngle,
          endAngle,
  ...
  const getSafeKey = (d) => {
    var _a, _b;
    return (_b = (_a = d.data) == null ? void 0 : _a.key) == null ? void 0 : _b.replace(" ", "");
  };
  const VennSeries = ({
    data,
    id,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      framerMotion.motion.g,
      {
        ...
        children: [
          ...
          data.map((d, index) => /* @__PURE__ */ jsxRuntime.jsx(
            "use",
            {
  ...
  const MeterColumn = ({
    ...
    const isActive = scale(index) <= value2;
  ...
  const FunnelArc = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("g", { pointerEvents: "none", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        framerMotion.motion.path,
        {
  ...
  const FunnelChart = ({
    ...
    const getScales = react.useCallback(({ chartWidth, chartHeight }) => {
      ...
      const xScale = d3Scale.scaleLinear().domain([0, data.length]).range([0, chartWidth]);
      return {
        yScale,
        xScale
      };
    }, [data]);
    const getDatas = react.useCallback(({ chartWidth, chartHeight }) => {
      if (arc.props.variant === "layered") {
        ...
        return {
          halfOffset,
          datas: [
            { data, ...getScales({ chartHeight, chartWidth }) },
    ...
    const renderChart = react.useCallback(
      ({ id: id2, chartWidth, chartHeight, chartSized }) => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          datas.map((d, i) => /* @__PURE__ */ jsxRuntime.jsx("g", { style: { transform: `translate(0, ${i * halfOffset}px)` }, children: /* @__PURE__ */ jsxRuntime.jsx(
            rdk.CloneElement,
            {
              element: arc,
              ...d,
