...
export declare class TooltipArea extends Component<TooltipAreaProps, TooltipAreaState> {
    ...
    transformData: import("memoize-one").MemoizedFn<(series: ChartInternalDataShape[]) => TooltipDataShape[]>;
    renderRadial(): import("react/jsx-runtime").JSX.Element;
    renderLinear(): import("react/jsx-runtime").JSX.Element;
